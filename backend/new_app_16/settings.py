"""
Django settings for new_app_16 project.
...
WSGI_APPLICATION = 'new_app_16.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_16 API",
    "DESCRIPTION": "API documentation for new_app_16 App",
    "VERSION": "v1",
}
